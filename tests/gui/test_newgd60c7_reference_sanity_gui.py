    ...
    with _static_server(root_dir) as base_url:
        with sync_playwright() as p:
            ...
            def assert_variant_matches_reference(variant_key: str, step_label: str):
                ...
                _assert_exact_decimal(read_input("#tinyHeight"), base["height"], f"{step_label} altura")
                _assert_exact_decimal(read_input("#tinyWidth"), base["width"], f"{step_label} largura")
                _assert_exact_decimal(read_input("#tinyLength"), base["length"], f"{step_label} comprimento")
                _assert_exact_decimal(read_input("#tinyWeight"), base["weight"], f"{step_label} peso")
