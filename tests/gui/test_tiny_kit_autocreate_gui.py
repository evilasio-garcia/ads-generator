    ...
    return {
        ...
        "base_state": {
            ...
            "product_fields": {
                ...
                "height_cm": str(product.get("height_cm") or ""),
                "width_cm": str(product.get("width_cm") or ""),
                "length_cm": str(product.get("length_cm") or ""),
                "weight_kg": str(product.get("weight_kg") or ""),
